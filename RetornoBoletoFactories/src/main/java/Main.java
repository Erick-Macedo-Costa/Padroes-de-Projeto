...
public class Main {
    public static void main(String[] args) throws URISyntaxException {
        var processarBoletos = new ProcessarBoletos(LeituraRetornoBancoBrasil::processarLinha);
        var processarBoletosBradesco = new ProcessarBoletos(LeituraRetornoBradesco::processarLinha);
